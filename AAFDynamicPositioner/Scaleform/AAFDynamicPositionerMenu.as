package  {
	...
	public class AAFDynamicPositionerMenu extends MovieClip implements ICodeObject {
      	private var f4seCodeObject;
		private var inputMap:Object = new Object();
		
		public function AAFDynamicPositionerMenu() {
        	super();
		...
		public function onF4SEObjCreated(codeObject:*) : void {
			this.f4seCodeObject = codeObject;
         	Shared.F4SEPlugin = this.f4seCodeObject.plugins.AAFDynamicPositioner;
		...
		public function ShowMenu(x:Number, y:Number, z:Number) : void {
			var view = new PositionerMenu(x, y, z);
			Shared.ShowView(view);
		}
		
		public function UpdateOffset(x:Number, y:Number, z:Number) : void {
			if (Shared.CurrentView is PositionerMenu)
				(Shared.CurrentView as PositionerMenu).UpdateSlider(x, y, z);
		}
	}
}