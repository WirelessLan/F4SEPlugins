...
namespace InputEnableManager {
	...
	void SetInputEnableLayer() {
		if (!g_inputEnableLayerEnabled) {
			...
			UInt32 userEventFlag = BSInputEnableManager::kUserEvent_Movement | BSInputEnableManager::kUserEvent_Menu | BSInputEnableManager::kUserEvent_Activate 
								| BSInputEnableManager::kUserEvent_Fighting	| BSInputEnableManager::kUserEvent_Sneaking;
			UInt32 otherEventFlag = BSInputEnableManager::kOtherEvent_JournalTabs | BSInputEnableManager::kOtherEvent_POVChange | BSInputEnableManager::kOtherEvent_VATS 
								| BSInputEnableManager::kOtherEvent_FAVORITES | BSInputEnableManager::kOtherEvent_Running;
