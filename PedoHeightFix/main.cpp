...
extern "C" {
	...
	bool F4SEPlugin_Load(const F4SEInterface* f4se) {
		...
		GetConfigValue("Options", "bUseCameraOverrideHeightFix", &g_pluginOptions.useCameraOverrideHeightFix);
		...
		_MESSAGE("bUseCameraOverrideHeightFix: %d", g_pluginOptions.useCameraOverrideHeightFix);
		...
		if (g_pluginOptions.useCameraOverrideHeightFix)
