...
namespace InputEnableManager {
	...
	void SetInputEnableLayer() {
		if (!g_inputEnableLayerEnabled) {
			...
			UInt32 userEventFlag = BSInputEnableManager::kUserEvent_Sneaking | BSInputEnableManager::kUserEvent_MainFourMenu;
			UInt32 otherEventFlag = BSInputEnableManager::kOtherEvent_JournalTabs | BSInputEnableManager::kOtherEvent_Activation | BSInputEnableManager::kOtherEvent_POVChange 
